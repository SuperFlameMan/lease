...
public class UserInfoController {
    ...
    public Result<IPage<UserInfo>> pageUserInfo(@RequestParam long current, @RequestParam long size, UserInfoQueryVo queryVo) {
        ...
        LambdaQueryWrapper<UserInfo> userInfoQueryVoLambdaQueryWrapper = new LambdaQueryWrapper<>();
        userInfoQueryVoLambdaQueryWrapper.like(queryVo.getPhone()!=null,UserInfo::getPhone,queryVo.getPhone());
        userInfoQueryVoLambdaQueryWrapper.like(queryVo.getStatus()!=null,UserInfo::getStatus,queryVo.getStatus());
        IPage<UserInfo> page = userInfoService.page(userInfoPage, userInfoQueryVoLambdaQueryWrapper);
