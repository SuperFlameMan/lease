...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> listByPage(IPage<AppointmentVo> page, AppointmentQueryVo queryVo) {
        IPage<AppointmentVo> iPage =viewAppointmentMapper.listByPage(page,queryVo);
        return iPage;
    }
}
